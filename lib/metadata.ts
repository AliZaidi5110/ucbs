...
const siteUrl = "https://ucbs.co.uk";

export const defaultMetadata: Metadata = {
  metadataBase: new URL(siteUrl),
  title: {
    default: "UCBS | UK Card Machines & Fast Business Funding £5k–£500k",
    template: "%s | UCBS UK Business Solutions",
  },
  description:
    "Cut your card processing fees by up to 40% with £0 upfront terminals and access flexible UK business funding from £5,000 to £500,000 approved in 24 hours. Repayments flex with your sales.",
  keywords: [
    "card machines UK",
  ...
  authors: [{ name: "UCBS" }],
  creator: "UCBS Commercial Business Solutions",
  publisher: "UCBS",
  ...
  openGraph: {
    ...
    locale: "en_GB",
    url: siteUrl,
    siteName: "UCBS Business Solutions",
...
export function generateServiceSchema(name: string, description: string, url: string) {
  return {
    ...
    provider: {
      "@type": "Organization",
      name: "UCBS Commercial Business Solutions",
      url: siteUrl,
    },
  };
}
...
export function generateLocalBusinessSchema() {
  return {
    ...
    url: siteUrl,
    address: { "@type": "PostalAddress", addressCountry: "UK" },
    priceRange: "££",
